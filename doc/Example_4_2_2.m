%% Example 4.2.2: Estimation Over a Network 2 in Simulink
...
% 
% Click
% <matlab:hybrid.open('CPS_examples\Network_2','Network_2_example.slx') here> 
% to change your working directory to the Example 4.2.2 folder and open the
% Simulink model. 
%% Mathematical Model
% 
...
% 
% 
% For each hybrid system in the Simulink Model (HSu, network, and Estimator) we have the following Matlab embedded functions that describe the sets $C$ and $D$ and functions $f$ and $g$.
%
%
%% Steps to Run Model
% 
...
%% Simulink Model
% The following diagram shows the Simulink model of the estimator over a network. The
...
% *flow map* |f| *block*
% 
% <include>src/Matlab2tex_CPS_Network_2/f.m</include>
%
% *flow set* |C| *block*
% 
% <include>src/Matlab2tex_CPS_Network_2/C.m</include>
%
% *jump map* |g| *block*
% 
% <include>src/Matlab2tex_CPS_Network_2/g.m</include>
%
% *jump set* |D| *block*
% 
% <include>src/Matlab2tex_CPS_Network_2/D.m</include>
%
% *Network:*
%
% *flow map* |f_network| *block*
% 
% <include>src/Matlab2tex_CPS_Network_2/f_network.m</include>
%
% *flow set* |C_network| *block*
% 
% <include>src/Matlab2tex_CPS_Network_2/C_network.m</include>
%
% *jump map* |g_network| *block*
% 
% <include>src/Matlab2tex_CPS_Network_2/g_network.m</include>
%
% *jump set* |D_network| *block*
% 
% <include>src/Matlab2tex_CPS_Network_2/D_network.m</include>
%
% *Estimator:*
%
% *flow map* |f_Estimator| *block*
% 
% <include>src/Matlab2tex_CPS_Network_2/f_Estimator.m</include>
%
% *flow set* |C_Estimator| *block*
% 
% <include>src/Matlab2tex_CPS_Network_2/C_Estimator.m</include>
%
% *jump map* |g_Estimator| *block*
% 
% <include>src/Matlab2tex_CPS_Network_2/g_Estimator.m</include>
%
% *jump set* |D_Estimator| *block*
% 
% <include>src/Matlab2tex_CPS_Network_2/D_Estimator.m</include>
%

%% Example Output
% The solution to the estimation over network system from $z(0,0)=[1, 0.1, 1, 0.6]^\top, \hat{z}(0,0)=[0, 0, 0, 0, 0]^\top$ and with
% |T=20, J=20, rule=1| shows that the estimated state approaches the system's state before $t
% = 10$, with a relatively small error.
clf
...
% * The initialization script |initialization_exNetwork_2.m| is edited by opening the file
...
% * The postprocessing script |postprocessing_Network_2.m| is edited by opening the file
...
%   values defined in |initialization_exNetwork_2.m| by selecting |Simulation>Configuration
