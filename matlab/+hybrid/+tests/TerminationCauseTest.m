classdef TerminationCauseTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testInfinite(testCase)
            ...
            C = 1;
            D = 1;
            cause = hybrid.TerminationCause.getCause(t, j, x, C, D, [0, 100], [0, 100]);
            testCase.assertEqual(cause, hybrid.TerminationCause.STATE_IS_INFINITE)
        end
        ...
        function testNaN(testCase)
            ...
            D = 1;
            cause = hybrid.TerminationCause.getCause(t, j, x, C, D, [0, 100], [0, 100]);
            testCase.assertEqual(cause, hybrid.TerminationCause.STATE_IS_NAN)
        end
        ...
        function testContinuousTimeLeftTSpan(testCase)
            ...
            D = 1;
            cause = hybrid.TerminationCause.getCause(t, j, x, C, D, [0, 100], [0, 100]);
            testCase.assertEqual(cause, hybrid.TerminationCause.T_REACHED_END_OF_TSPAN)
        end
        ...
        function testDiscreteTimeLeftJSpan(testCase)
            ...
            C = 1;
            D = 1;
            cause = hybrid.TerminationCause.getCause(t, j, x, C, D, [0, 100], [0, 2]);
            testCase.assertEqual(cause, hybrid.TerminationCause.J_REACHED_END_OF_JSPAN)
        end
