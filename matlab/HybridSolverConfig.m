...
% © 2021. 
    ...
    properties(SetAccess = private)
        ...
        % See also: HybridSolverConfig.priority, hybrid.Priority.
        hybrid_priority = hybrid.Priority.JUMP;
        ...
        progressListener = hybrid.PopupProgressUpdater(); % Is a hybrid.ProgressUpdater
    end
    ...
    methods
        function this = HybridSolverConfig(varargin)
            ...
            if ~isempty(varargin) && strcmp(varargin{1}, 'silent')
                this.progressListener = hybrid.SilentProgressUpdater();
        ...
        function this = priority(this, priority)
            ...
            this.hybrid_priority = hybrid.Priority(priority);
            if nargout == 0
               clear this 
            end
        end
        ...
        function this = progress(this, progress, varargin)
            ...
            % 
            % See also: hybrid.ProgressUpdater, hybrid.PopupProgressUpdater,
            % hybrid.SilentProgressUpdater.
            ...
            if ~ischar(progress)
                if isa(progress, 'hybrid.ProgressUpdater')
                    this.progressListener = progress;
                else
                    error('HybridSolverConfig:InvalidProgress', ...
                        'The progress listener must be a subclass of hybrid.ProgressUpdater, but instead was ''%s''.',...
                        class(progress));
                end
                if nargout == 0
                   clear this 
            ...
            switch progress
                case 'popup'
                    this.progressListener = hybrid.PopupProgressUpdater(varargin{:});
                case 'silent'
                    this.progressListener = hybrid.SilentProgressUpdater();
                otherwise
                    error('HybridSolverConfig:InvalidProgress', ...
