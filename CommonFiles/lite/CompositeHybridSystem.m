...
%%% COMPOSITEHYBRIDSYSTEM Creates a hybrid system that consists of N
...
%%% its own discrete time).
    ...
    methods
        function obj = CompositeHybridSystem(varargin) % Constructor
    ...
    methods
        ...
        function sol = solve(this, xs_0, tspan, jspan, config)
            % SOLVE Compute the solution to the composite system with the
            ...
            if config.hybrid_priority == HybridPriority.FLOW
                warning("CompositeHybridSystem:FlowPriorityNotSupported", ...
                    "Using CompositeHybridSystems with FLOW priority is not reccomended. " + ...
