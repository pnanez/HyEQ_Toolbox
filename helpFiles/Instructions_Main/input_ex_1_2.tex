...
{
\psfragfig[width=.45\textwidth]{figures/Examples/FlowsAndJumps1lite}
{
...
{
    \psfragfig[width=.45\textwidth]{figures/Examples/FlowsAndJumps2lite}
{
  \psfrag{flows [t]}[c]{flows [$t$]}
  \psfrag{jumps [j]}[c]{jumps [$j$]}
  \psfrag{x1}[c]{$x_1$}
...
For MATLAB files of this example, see \IfSAE{Examples/Example\_\ref{ex:bblite}}{Examples/Example\_1.2}.
