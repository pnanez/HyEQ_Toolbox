...
%so much space.  Perhaps a page with a 2x2 grid of figures?}
...
%  \psfrag{x}[c]{$x$}
%    {\includegraphics[width=.8\textwidth]{figures/Examples/Overlap1JumpPriority.eps}}
%   \caption{Solution of Example~\ref{ex:overlap1} with forced jumps logic.}
%%File: Overlap1.zip.
%\label{fig:overlap1-1}
%  \end{center}
%\end{figure}
...
\subfigure[Forced jumps logic.]{
    \includegraphics[width=.45\textwidth]{figures/Examples/Overlap1JumpPriority.eps}
\label{fig:overlap1-1}}

\subfigure[Forced flows logic.]{
    \includegraphics[width=.45\textwidth]{figures/Examples/Overlap1FlowPriority.eps}
\label{fig:overlap1-2}}
\qquad
...
%  \psfrag{jumps [j]}[c]{jumps [$j$]}
%  \psfrag{x}[c]{$x$}
%    {\includegraphics[width=.8\textwidth]{figures/Examples/Overlap1FlowPriority.eps}}
%   \caption{Solution of Example~\ref{ex:overlap1} with forced flows logic.}
%%File: Overlap1.zip.
%\label{fig:overlap1-2}
%  \end{center}
%\end{figure}
...
%  \psfrag{jumps [j]}[c]{jumps [$j$]}
%  \psfrag{x}[c]{$x$}
%    {\includegraphics[width=.8\textwidth]{figures/Examples/Overlap1RandomPriority.eps}}
%   \caption{Solution of Example~\ref{ex:overlap1} with random logic for flowing/jumping.}
%%File: Overlap1.zip.
%\label{fig:overlap1-3}
%  \end{center}
%\end{figure}
...
%  \psfrag{jumps [j]}[c]{jumps [$j$]}
%  \psfrag{x}[c]{$x$}
%    {\includegraphics[width=.8\textwidth]{figures/Examples/Overlap1TRandomPriority.eps}}
%   \caption{Solution of Example~\ref{ex:overlap1} with random logic for flowing/jumping.}
%%File: Overlap1T.zip
%\label{fig:overlap1T-1}
%  \end{center}
...
%  \psfrag{jumps [j]}[c]{jumps [$j$]}
%  \psfrag{x}[c]{$x$}
%    {\includegraphics[width=.8\textwidth]{figures/Examples/Overlap1TRandomPriorityZoom.eps}}
%   \caption{Solution of Example~\ref{ex:overlap1} with random logic for flowing/jumping. Zoomed version.}
%%File: Overlap1T.zip
%\label{fig:overlap1T-2}
%  \end{center}
%\end{figure}
...
%
%Replacing $O$ by $(-1,2)$, a solution starting
%from $x0=1$ with $T=10,J=20$, $rule = 1$ fails to exists
%after the first jump. This is depicted in Figure~\ref{fig:overlap2-1}
%(cf. Figure~\ref{fig:overlap1-1})
%\\
...
%  \psfrag{jumps [j]}[c]{jumps [$j$]}
%  \psfrag{x}[c]{$x$}
%    {\includegraphics[width=.8\textwidth]{figures/Examples/Overlap2JumpPriority.eps}}
%   \caption{Solution of Example~\ref{ex:overlap1} with forced jump logic and different $D$.}
%\label{fig:overlap2-1}
%  \end{center}
%\end{figure}

% show stopping logic by D
...
%  \psfrag{jumps [j]}[c]{jumps [$j$]}
%  \psfrag{x}[c]{$x$}
%    {\includegraphics[width=.8\textwidth]{figures/Examples/Overlap4FlowPriority.eps}}
%   \caption{Solution of Example~\ref{ex:overlap1} with forced flow logic.}
%\label{fig:overlap4-1}
%  \end{center}
%\end{figure}
